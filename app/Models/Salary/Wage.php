 ...
 * @mixin \Eloquent
 * @property float $should_total 应发合计
 * @property float $salary_total 工资薪金
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Salary\Wage whereSalaryTotal($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Salary\Wage whereShouldTotal($value)
 */
